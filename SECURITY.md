...
Syla Receipts does not hold funds, sign blockchain transactions, or store provider credentials. Adapters accept post-run metadata from your application. Never place private keys, API keys, complete prompts, or sensitive tool responses into a receipt unless your own security model explicitly permits it.
